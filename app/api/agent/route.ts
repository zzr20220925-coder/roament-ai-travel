      ...
      text: {
        format: {
          ...
          schema: {
            type: "object",
            properties: {
              action: { type: "string", enum: ["place_search", "dining_search", "weather_replan", "delay_replan", "fatigue_replan", "budget_replan", "open_planner", "general"] },
            ...
            required: ["action", "placeQuery", "placeLabel", "cuisineQuery", "cuisineLabel", "minRating", "budgetAmount", "budgetCurrency", "time", "explanation"],
